...
#     price_per_dayss = fields.Float("Price per Day")
...
#
#     price_per_dayss = fields.Float(
#         string="Price per Day",
#         related="bed_type_id.price_per_dayss",
#         store=True,
#         readonly=True,
#     )
...
#
#             total_price = num_days * bed.price_per_dayss
#
#             invoice_vals = {
...
#                             "quantity": num_days,
#                             "price_unit": bed.price_per_dayss,
...
class HospitalBedType(models.Model):
    ...
    price_per_dayss = fields.Monetary("Price per Day")
    name = fields.Char("Bed Type", required=True)
    total_beds = fields.Integer("Total Beds", required=True, default=0)
    occupied_beds = fields.Integer(
        "Occupied Beds", compute="_compute_occupied_beds", store=True
...
class HospitalBed(models.Model):
    ...
    price_per_dayss = fields.Monetary(
        string="Price per Day",
        related="bed_type_id.price_per_dayss",
        store=True,
        readonly=True,
